...
export function generatePersonalizationConfig(profile: VisitorProfile): PersonalizationConfig {
  ...
  if (String(profile.trafficSource || '').toLowerCase().includes('facebook')) {
    config = {
      ...config,
  ...
  if (String(profile.trafficSource || '').toLowerCase().includes('google')) {
    config = {
      ...config,
  ...
  if (String(profile.trafficSource || '').toLowerCase().includes('substack')) {
    config = {
      ...config,
