...
// YouTube IDs for Alexander Scourby KJV Audio Bible
export const scourbyAudioMap: Record<string, string> = {
  ...
  Luke: 'Ue7vF-5FP6A',
  John: 'fJgANK8_JFY',
  // Add more as needed - these are example IDs
  // You would need to find the correct YouTube video IDs for each book
};
